      ...
      <div ref={scrollRef}>
        <section className="py-20 px-6">
          <div className="container mx-auto max-w-3xl text-center mb-12 scroll-reveal">
            <h1 className="font-heading text-4xl md:text-5xl text-primary mb-4 reveal-child">Get in Touch</h1>
          ...
          <div className="container mx-auto max-w-xl text-center mb-10 space-y-3 scroll-reveal">
            <div className="flex items-center justify-center gap-3 font-body text-foreground/80 reveal-child">
          ...
          <div className="container mx-auto max-w-xl text-center mb-16 scroll-reveal">
            <button
              onClick={openWhatsApp}
              className="w-full px-8 py-5 bg-primary text-primary-foreground font-heading text-base uppercase tracking-widest rounded btn-gold-glow flex items-center justify-center gap-4"
            >
          ...
          <div className="container mx-auto max-w-xl mt-8 scroll-reveal">
            {submitted ? (
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="w-full px-6 py-4 bg-primary text-primary-foreground font-heading text-sm uppercase tracking-widest rounded btn-gold-glow disabled:opacity-50"
                >
