      ...
      <PageWrapper>
        <section className="py-20 px-6">
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="bg-card border border-primary/15 rounded overflow-hidden page-enter">
      ...
      <section className="py-20 px-6">
        ...
        <div className="container mx-auto max-w-6xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
          {recipes.map((recipe, i) => (
            <div
              key={i}
              className="bg-card border border-primary/20 rounded overflow-hidden flex flex-col group hover:border-primary/60 transition-all duration-300 hover:shadow-[0_0_30px_hsl(43,52%,54%,0.1)]"
            >
