...
const WhatsAppFloat = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-primary text-primary-foreground rounded-full flex items-center justify-center shadow-[0_4px_20px_hsl(43,52%,54%,0.4)] btn-gold-glow"
    >
